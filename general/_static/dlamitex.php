...
<?php
	...
	$messagecea .= "Cadre d'utilisation : " . $_POST['cadre'] . "\r\n" . "\r\n";
		...
		$_POST['accmail']="o";
		$messagecea .= "D�sire recevoir les mails Cast3M : oui"  . "\r\n";
	}		
	else {
		$_POST['accmail']="n";
		$messagecea .= "D�sire recevoir les mails Cast3M : non"  . "\r\n";
	}*/
...
echo $versionchoisie;
	...
	// Affichage du formulaire ; Si la variable $soumis est � true, on v�rifie �galement que certains champs sont correctement remplis
				...
				<legend><?php echo $phraseTitreAct;?></legend>	
					...
					<tr>
						...
						<td colspan="2" style="padding-top: 20px;">
							...
							// Affichage du menu d�roulant : on boucle � l'int�rieur du tableau $choixUtilisation (fichiers local_fr et local_en dans le r�pertoire inc)
							// pour afficher une option du menu pour chaque valeur
							// On regarde aussi quelle valeur du menu a �t� s�lectionn�e pr�c�demment (si formulaire soumis au moins une fois)
							// pour la res�lectionner automatiquement dans le cas o� certaines valeurs manquaient dans d'autres champs
